...
> Tip: the project can enforce this automatically with the free
> [CLA Assistant](https://cla-assistant.io/) GitHub app, which posts a sign-off
> checkbox on every PR.
