...
func (ClientHttpConnection) SetDeadline(t time.Time) error {
	return nil
}
...
func (ClientHttpConnection) SetReadDeadline(t time.Time) error {
	return nil
}
...
func (ClientHttpConnection) SetWriteDeadline(t time.Time) error {
	return nil
}
...
// LocalAddr returns the local network address.
func (*ServerHttpConnection) LocalAddr() net.Addr {
	return nil
}

// RemoteAddr returns the remote network address.
func (*ServerHttpConnection) RemoteAddr() net.Addr {
	return nil
}
...
//
// A zero value for t means I/O operations will not time out.
func (*ServerHttpConnection) SetDeadline(t time.Time) error {
	return nil
}
...
// and any currently-blocked Read call.
// A zero value for t means Read will not time out.
func (*ServerHttpConnection) SetReadDeadline(t time.Time) error {
	return nil
}
...
// some of the data was successfully written.
// A zero value for t means Write will not time out.
func (*ServerHttpConnection) SetWriteDeadline(t time.Time) error {
	return nil
}
